...
def populate():
    python_pages = [
        ...
        {"title": "Learn Python in 10 Minutes", "url": "http://www.korokithakis.net/tutorials/python/", "views":110},
    ]

    django_pages = [
        {"title": "Official Django Tutorial", "url": "https://docs.djangoproject.com/en/2.1/intro/tutorial01/", "views": 90},
        {"title": "Django Rocks", "url": "http://www.djangorocks.com/", "views": 76},
